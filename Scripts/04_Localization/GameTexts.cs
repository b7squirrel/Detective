    ...
    public string[] gradeNames = new string[]
{
    ...
    public string keepTapping = "계속 탭탭탭! 오리가 진화해요!";
    ...
    [TextArea(2, 4)] public string changeLeadOriPopup = "꿀팁!\n슬롯을 터치하면\n출동할 오리를 바꿀 수 있어요!";
    ...
    [TextArea] public string maxLevelForNow = "이번에는 특별히 최고 레벨 카드를 드립니다.";
