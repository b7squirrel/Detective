...
public class EnemyLaserProjectile : MonoBehaviour
{
    ...
    public void Initialize(float _damage, LayerMask _destructables, LayerMask _walls, float _duration)
    {
        damage = _damage;
    ...
    void CastLaser()
    {
        ...
        {
            RaycastHit2D[] hits = Physics2D.RaycastAll(startPos, direction, maxDistance, destructables);
