...
/// 2. CardDataManager (플레이어 카드 데이터)
/// 3. EquipmentDataManager (장비 장착 데이터)
/// 4. CardList 초기화 (런타임 객체 생성)
/// </summary>
